...
// const blockPath = (nodes) => {
// 	for(let i = 0; i < nodes.length; i++){
// 		let node = document.querySelector(`div[row='${nodes[i][0]}'][col='${nodes[i][1]}']`);
// 		node.setAttribute("wall", 1);
// 	}
// 	let startNode = document.querySelector(`div[row='${4}'][col='${5}']`);
// 	startNode.setAttribute("wall", 0);
// }
...
export const findPaths = (x1 = 0, y1 = 0, x2 = rowSize - 1, y2 = colSize - 1) => {
